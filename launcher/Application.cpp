...
Application::Application(int& argc, char** argv) : QApplication(argc, argv)
{
    ...
    /*
     * Establish the mechanism for communication with an already running SpikyMC that uses the same data path.
    ...
    // check update locks
    {
        auto updateLogPath = FS::PathCombine(m_dataPath, "logs", "spikymc_update.log");

        auto updateLock = QFileInfo(FS::PathCombine(m_dataPath, ".spikymc_update.lock"));
        ...
        auto updateFailMarker = QFileInfo(FS::PathCombine(m_dataPath, ".spikymc_update.fail"));
        ...
        auto updateSuccessMarker = QFileInfo(FS::PathCombine(m_dataPath, ".spikymc_update.success"));
