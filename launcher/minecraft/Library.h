...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by SpikyMC
   ...
   protected: /* data */
    ...
    /// DEPRECATED: SpikyMC-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// SpikyMC extension - filename override
    QString m_filename;

    /// DEPRECATED SpikyMC extension - display name
    QString m_displayname;

    /**
     * SpikyMC-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in SpikyMC, but could be elsewhere
     * SpikyMC specific, because of FTB.
     */
