...
class SpikyMCExternalUpdater : public ExternalUpdater {
    Q_OBJECT

   public:
    SpikyMCExternalUpdater(QWidget* parent, const QString& appDir, const QString& dataDir);
    ~SpikyMCExternalUpdater() override;
